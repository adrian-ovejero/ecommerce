...
class PageAlta {
    ...
    static validators = {
        ...
        'longDescription': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,2000}$/,
        'brand': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,200}$/,
        'stock': /^\d+$/,
        'category': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,200}$/,
        'freeShipping': /^[\wáéíóúüÁÉÍÓÚÜ ¿?¡!.,:-]{1,200}$/,
        'minAge': /^\d+$/,
        'maxAge': /^\d+$/,
        'img': /^(.*){1,2000}$/,
        'cantidad': /^\d+$/,
    ...
    static async init () {
        ...
        PageAlta.form = document.getElementById('mainForm');
        PageAlta.fields = PageAlta.form.querySelectorAll('input, textarea, select');
